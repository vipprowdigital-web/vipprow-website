  ...
  return (
    ...
    >
      ...
      >
        ...
        >
          {/* Background gradient */}
          <div className="from-blue-600/5 dark:from-blue-600/10 absolute inset-0 rounded-2xl bg-gradient-to-br via-transparent to-blue-500/5 dark:to-blue-500/10" />

          <div className="relative z-10 flex-1 space-y-5">
            <div className="space-y-2">
              <div className="mb-2 flex items-center gap-2">
                <div className="from-blue-600 via-blue-600/90 to-blue-600/80 flex h-8 w-8 items-center justify-center rounded-lg bg-gradient-to-br">
            ...
            <div className="space-y-2.5">
              {features.map((feature, index) => {
                ...
                return (
                  ...
                  >
                    <div className="bg-blue-600/10 dark:bg-blue-600/20 flex h-5 w-5 flex-shrink-0 items-center justify-center rounded-md">
                      <IconComponent className="text-blue-600 h-3 w-3" />
                    </div>
